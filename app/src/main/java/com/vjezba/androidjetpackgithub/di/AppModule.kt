...
import com.vjezba.data.di.StorageModule
import com.vjezba.data.di.UserManagerModule
...
@Module(includes = [ViewModelModule::class, CoreDataModule::class, StorageModule::class, UserManagerModule::class])
class AppModule {
